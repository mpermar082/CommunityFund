// src/lib.rs
/*
 * Core library for CommunityFund
 */
...
#[derive(Debug)]
pub struct CommunityFundProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CommunityFundProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CommunityFund processing");
    
    let mut processor = CommunityFundProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CommunityFundProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CommunityFundProcessor::new(false);
